...
EXPECTED_KIT="f95c2b347da97742fed3f20611f0eec2fd3df48694fed9494fb07163c537cfb7"
EXPECTED_SCHEMA="3d72b4e67ec9929c5d960cee8fc52db35d85ba5103e361f3a61a8f5078079c5d"
...
if kit.get("version")!="3.4.1" or kit.get("base_release")!="v3.4.0": errors.append("version_or_base")
...
print(json.dumps({"valid":not errors,"version":"3.4.1","vectors":len(rows),"valid_vectors":kit.get("valid_vectors"),

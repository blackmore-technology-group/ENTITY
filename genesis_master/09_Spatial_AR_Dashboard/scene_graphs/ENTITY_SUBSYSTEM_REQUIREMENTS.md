# ENTITY Subsystem Requirements — Scene Graphs
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `09_Spatial_AR_Dashboard/scene_graphs`
...
## Subsystem Purpose
Scene relationships must reference stable BSIE/ENTITY objects, preserve lineage and mark inferred relationships as derived rather than verified.

# ENTITY Subsystem Requirements — AR Dashboard
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `09_Spatial_AR_Dashboard/dashboard_ar`
...
## Subsystem Purpose
The dashboard may explain state but must not bypass ENTITY policy or become authoritative for rights/identity.

# ENTITY Subsystem Requirements — Remote Camera Projection
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `09_Spatial_AR_Dashboard/remote_camera_projection`
...
## Subsystem Purpose
Remote visual projection must enforce consent, classification, disclosure policy, authenticated endpoints and minimal context.

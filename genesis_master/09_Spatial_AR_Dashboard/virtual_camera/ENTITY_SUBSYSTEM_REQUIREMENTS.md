# ENTITY Subsystem Requirements — Virtual Camera
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `09_Spatial_AR_Dashboard/virtual_camera`
...
## Subsystem Purpose
Synthetic/virtual imagery must be declared where known and maintain provenance links to inputs and transformations.

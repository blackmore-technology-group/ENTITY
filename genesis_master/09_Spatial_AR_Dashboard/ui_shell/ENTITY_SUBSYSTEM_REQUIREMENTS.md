# ENTITY Subsystem Requirements — Spatial UI Shell
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `09_Spatial_AR_Dashboard/ui_shell`
...
## Subsystem Purpose
UI must communicate confidence, evidence state, warnings and authorization outcomes without overstating ownership or truth.

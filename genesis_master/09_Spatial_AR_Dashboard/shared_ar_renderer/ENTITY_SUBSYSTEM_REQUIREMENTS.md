# ENTITY Subsystem Requirements — Shared AR Renderer
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `09_Spatial_AR_Dashboard/shared_ar_renderer`
...
## Subsystem Purpose
Shared rendering must minimize disclosed identity/location data and keep presentation separate from authoritative state mutation.

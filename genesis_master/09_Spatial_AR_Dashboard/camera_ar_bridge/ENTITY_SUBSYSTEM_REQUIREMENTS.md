# ENTITY Subsystem Requirements — Camera/AR Bridge
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `09_Spatial_AR_Dashboard/camera_ar_bridge`
...
## Subsystem Purpose
Camera observations must record evidence origin and preserve the distinction between direct observation and AI-derived inference.

# ENTITY Subsystem Requirements — Web Publication
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `03_Public_Internet_Bridge/web_publish`
...
## Subsystem Purpose
Publication is an explicit ExportEvent with policy snapshot, terms impact, approval and outcome. It must not overwrite source rights or provenance.

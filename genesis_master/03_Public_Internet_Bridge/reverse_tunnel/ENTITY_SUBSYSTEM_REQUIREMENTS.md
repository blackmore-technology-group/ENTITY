# ENTITY Subsystem Requirements — Reverse Tunnel
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `03_Public_Internet_Bridge/reverse_tunnel`
...
## Subsystem Purpose
Reverse tunnels require explicit endpoint authorization, secure transport, revocation and containment; they must not create ambient access to vaults or internal services.

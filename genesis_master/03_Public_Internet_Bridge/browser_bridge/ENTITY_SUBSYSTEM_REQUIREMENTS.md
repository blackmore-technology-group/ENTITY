# ENTITY Subsystem Requirements — Browser Bridge
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `03_Public_Internet_Bridge/browser_bridge`
...
## Subsystem Purpose
Browser-originated content and instructions are untrusted until authorized. Browser export/import must preserve source policy, provenance and explicit scopes.

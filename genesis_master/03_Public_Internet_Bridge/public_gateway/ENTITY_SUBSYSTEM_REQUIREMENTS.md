# ENTITY Subsystem Requirements — Public Gateway
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `03_Public_Internet_Bridge/public_gateway`
...
## Subsystem Purpose
Expose only policy-approved data, minimize identifiers, enforce authentication/authorization, rate limits, structured errors and publication audit.

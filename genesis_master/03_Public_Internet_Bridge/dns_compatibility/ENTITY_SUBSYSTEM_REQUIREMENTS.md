# ENTITY Subsystem Requirements — DNS Compatibility
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `03_Public_Internet_Bridge/dns_compatibility`
...
## Subsystem Purpose
DNS compatibility must support public reachability without making DNS ownership equivalent to Entity identity or rights ownership.

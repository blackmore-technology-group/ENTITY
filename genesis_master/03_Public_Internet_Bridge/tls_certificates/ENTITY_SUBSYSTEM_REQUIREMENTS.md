# ENTITY Subsystem Requirements — TLS Certificates
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `03_Public_Internet_Bridge/tls_certificates`
...
## Subsystem Purpose
Certificate lifecycle must support issuance, rotation, expiry and revocation while remaining separate from sovereign identity and rights claims.

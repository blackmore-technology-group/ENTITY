# ENTITY Subsystem Requirements — Prototype Sites
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `19_Sandbox/prototype_sites`
...
## Subsystem Purpose
Prototype publication must not expose restricted production data or imply production rights/terms status.

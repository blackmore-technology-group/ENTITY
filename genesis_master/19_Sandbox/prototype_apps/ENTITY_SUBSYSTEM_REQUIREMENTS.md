# ENTITY Subsystem Requirements — Prototype Apps
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `19_Sandbox/prototype_apps`
...
## Subsystem Purpose
Prototype apps must use non-production scopes and cannot acquire production authority by promotion without review and qualification.

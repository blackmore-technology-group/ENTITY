# ENTITY Subsystem Requirements — Prototype Nodes
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `19_Sandbox/prototype_nodes`
...
## Subsystem Purpose
Prototype nodes must be isolated from production trust and settlement and must declare experimental protocol/crypto versions.

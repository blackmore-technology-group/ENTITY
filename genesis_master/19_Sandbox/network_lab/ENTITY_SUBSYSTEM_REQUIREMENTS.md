# ENTITY Subsystem Requirements — Network Lab
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `19_Sandbox/network_lab`
...
## Subsystem Purpose
Use isolated identities/credentials/value state for network experiments; test downgrade, replay, partition, relay and abuse cases.

# ENTITY Subsystem Requirements — Prototype Entities
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `19_Sandbox/prototype_entities`
...
## Subsystem Purpose
Prototype identities must remain distinguishable from verified/production entities and cannot confer real economic authority.

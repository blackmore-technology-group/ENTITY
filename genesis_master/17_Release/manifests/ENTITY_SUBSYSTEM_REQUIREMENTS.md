# ENTITY Subsystem Requirements — Release Manifests
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `17_Release/manifests`
...
## Subsystem Purpose
Manifests must identify versions, schemas, crypto suites, components, dependencies, migrations and qualification state.

# ENTITY Subsystem Requirements — Release Builds
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `17_Release/builds`
...
## Subsystem Purpose
Builds must be reproducible where practical and linked to source commit, dependencies, tests and qualification evidence.

# ENTITY Subsystem Requirements — Release Signatures
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `17_Release/signatures`
...
## Subsystem Purpose
Release signatures must identify signer, authority, algorithm, key version, payload schema and time and remain verifiable after key rotation.

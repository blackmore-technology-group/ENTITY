# ENTITY Subsystem Requirements — Release Notes
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `17_Release/release_notes`
...
## Subsystem Purpose
Release notes must accurately state implemented/qualified capability, known limitations, migrations and unresolved risks without overstating TRL.

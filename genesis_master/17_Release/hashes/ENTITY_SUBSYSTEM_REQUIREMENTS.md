# ENTITY Subsystem Requirements — Release Hashes
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `17_Release/hashes`
...
## Subsystem Purpose
Record strong algorithm-identified hashes for release artifacts, evidence and dependencies without treating hashes as ownership proof.

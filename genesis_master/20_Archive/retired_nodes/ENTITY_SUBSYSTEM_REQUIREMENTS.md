# ENTITY Subsystem Requirements — Retired Nodes
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `20_Archive/retired_nodes`
...
## Subsystem Purpose
Retired nodes must preserve historical evidence and revoke active device/node authority.

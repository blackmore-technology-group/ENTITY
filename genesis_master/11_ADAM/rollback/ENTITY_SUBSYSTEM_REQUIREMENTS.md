# ENTITY Subsystem Requirements — ADAM Rollback
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `11_ADAM/rollback`
...
## Subsystem Purpose
Rollback must use corrective/superseding state, not erase finalized evidence, and must respect contract/payment semantics.

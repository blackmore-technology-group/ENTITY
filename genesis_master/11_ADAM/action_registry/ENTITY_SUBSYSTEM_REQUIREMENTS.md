# ENTITY Subsystem Requirements — ADAM Action Registry
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `11_ADAM/action_registry`
...
## Subsystem Purpose
Every executable action must have a defined operation identifier, required capability, scope, risk classification, approval rule and audit semantics.

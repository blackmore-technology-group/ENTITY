# ENTITY Subsystem Requirements — ADAM Executors
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `11_ADAM/executors`
...
## Subsystem Purpose
Executors must validate current capabilities and policy immediately before execution and fail closed on invalid/expired/revoked authority.

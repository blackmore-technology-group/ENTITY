# ENTITY Subsystem Requirements — ADAM Approval Gates
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `11_ADAM/approval_gates`
...
## Subsystem Purpose
High-impact actions require policy-driven human/organizational approval with threshold authority and immutable approval evidence.

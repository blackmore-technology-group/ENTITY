# ENTITY Subsystem Requirements — ADAM Tests
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `11_ADAM/tests`
...
## Subsystem Purpose
Tests must cover capability expiry/revocation, approval bypass, prompt injection, replay, wrong actor/scope and irreversible-action safeguards.

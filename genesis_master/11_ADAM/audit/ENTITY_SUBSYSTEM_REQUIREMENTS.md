# ENTITY Subsystem Requirements — ADAM Audit
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `11_ADAM/audit`
...
## Subsystem Purpose
Audit records must capture actor, authority, object, action, policy, time and outcome without exposing unnecessary secrets.

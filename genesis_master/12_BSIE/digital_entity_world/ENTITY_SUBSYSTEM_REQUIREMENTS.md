# ENTITY Subsystem Requirements — Digital Entity World
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `12_BSIE/digital_entity_world`
...
## Subsystem Purpose
World state must bind to stable Entity identifiers while keeping world facts distinct from rights/legal claims.

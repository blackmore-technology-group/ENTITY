# ENTITY Subsystem Requirements — BSIE Projections
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `12_BSIE/projections`
...
## Subsystem Purpose
Projections must be purpose-scoped, least privilege and privacy-aware, exposing only fields needed by consuming subsystems.

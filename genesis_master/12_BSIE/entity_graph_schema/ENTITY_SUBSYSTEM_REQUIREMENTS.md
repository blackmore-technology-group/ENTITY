# ENTITY Subsystem Requirements — Entity/World Graph Schema
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `12_BSIE/entity_graph_schema`
...
## Subsystem Purpose
Schemas must preserve evidence origin, lineage, versioning, stable identifiers and compatibility with ENTITY relationship objects.

# ENTITY Subsystem Requirements — Physical World Bridge
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `12_BSIE/physical_world_bridge`
...
## Subsystem Purpose
Physical observations must distinguish sensor observation, external records and derived inference; no sensor result automatically establishes legal rights.

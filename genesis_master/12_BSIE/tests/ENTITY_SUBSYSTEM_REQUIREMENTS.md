# ENTITY Subsystem Requirements — BSIE Integration Tests
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `12_BSIE/tests`
...
## Subsystem Purpose
Tests must verify identity mapping, evidence origin, projection minimization, migration compatibility and no rights-authority leakage.

# ENTITY Subsystem Requirements — Node Templates
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `05_Entity_Nodes/node_templates`
...
## Subsystem Purpose
Node templates must declare protocol, crypto, capabilities, trust assumptions and required security controls without embedding production secrets.

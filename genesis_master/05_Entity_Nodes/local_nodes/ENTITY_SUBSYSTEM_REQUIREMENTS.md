# ENTITY Subsystem Requirements — Local Nodes
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `05_Entity_Nodes/local_nodes`
...
## Subsystem Purpose
Local nodes must support offline signed operations, local verification, protected keys, recovery and later reconciliation.

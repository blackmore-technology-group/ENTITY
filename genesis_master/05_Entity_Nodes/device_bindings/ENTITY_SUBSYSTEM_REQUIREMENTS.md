# ENTITY Subsystem Requirements — Device Bindings
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `05_Entity_Nodes/device_bindings`
...
## Subsystem Purpose
Device authorization must be explicit, revocable and separate from root identity. Device loss or compromise must not destroy or take over sovereign identity.

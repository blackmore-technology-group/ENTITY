# ENTITY Subsystem Requirements — Remote Nodes
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `05_Entity_Nodes/remote_nodes`
...
## Subsystem Purpose
Remote nodes require authenticated identity, compatible protocol/crypto suites, trust policy and revocation-aware credential evaluation.

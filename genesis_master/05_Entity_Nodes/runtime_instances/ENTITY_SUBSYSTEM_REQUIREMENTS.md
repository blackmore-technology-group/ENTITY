# ENTITY Subsystem Requirements — Node Runtime Instances
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `05_Entity_Nodes/runtime_instances`
...
## Subsystem Purpose
Runtime instances must expose health/version state, isolate authority, record auditable actions and reject replay/conflicting exclusive operations.

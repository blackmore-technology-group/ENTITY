# ENTITY Subsystem Requirements — Public Peer Qualification
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `16_Test_Qualification/Public_Peer`
...
## Subsystem Purpose
Pre-bootstrap/public-peer evidence must remain historical external evidence at its original assurance level and be adopted idempotently after controller bootstrap.

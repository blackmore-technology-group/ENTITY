# ENTITY Subsystem Requirements — Peer Network Qualification
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `16_Test_Qualification/peer_network`
...
## Subsystem Purpose
Test authentication, negotiation, signed downgrade detection, credential constraints/revocation, partition, replay and reconciliation.

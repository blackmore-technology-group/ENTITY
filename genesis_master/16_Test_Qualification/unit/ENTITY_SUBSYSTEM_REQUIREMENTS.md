# ENTITY Subsystem Requirements — Unit Tests
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `16_Test_Qualification/unit`
...
## Subsystem Purpose
Every security-sensitive state transition requires positive/negative tests including revoked keys, wrong parties, replay, duplicate IDs, policy denial and invalid signatures.

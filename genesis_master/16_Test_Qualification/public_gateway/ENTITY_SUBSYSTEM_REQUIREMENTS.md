# ENTITY Subsystem Requirements — Public Gateway Qualification
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `16_Test_Qualification/public_gateway`
...
## Subsystem Purpose
Verify export separation, rights-impact warnings, terms snapshots, approvals, external IDs and no source-rights overwrite.

# ENTITY Subsystem Requirements — Resilience Qualification
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `16_Test_Qualification/resilience`
...
## Subsystem Purpose
Test provider outage, network partition, device loss, backup restore, relay failure, offline operation and rejoin.

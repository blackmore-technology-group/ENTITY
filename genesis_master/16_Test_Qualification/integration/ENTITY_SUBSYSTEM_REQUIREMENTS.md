# ENTITY Subsystem Requirements — Integration Qualification
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `16_Test_Qualification/integration`
...
## Subsystem Purpose
Test end-to-end identity, rights, policy, licensing, usage, settlement, export, recovery and independent verification across subsystem boundaries.

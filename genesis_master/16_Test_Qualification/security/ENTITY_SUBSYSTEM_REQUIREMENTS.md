# ENTITY Subsystem Requirements — Security Qualification
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `16_Test_Qualification/security`
...
## Subsystem Purpose
Attempt unauthorized mutation/disclosure, root takeover, signature bypass, agent/connector escalation, prompt injection and exfiltration.

# ENTITY Subsystem Requirements — Static Assets
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `06_Hosted_Sites/static_assets`
...
## Subsystem Purpose
Static assets must be registered or traceable where governed, with hashes, lineage, rights state and C2PA where applicable.

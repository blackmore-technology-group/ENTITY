# ENTITY Subsystem Requirements — Site Data
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `06_Hosted_Sites/site_data`
...
## Subsystem Purpose
Site data must retain classification, consent, provenance, retention and deletion policy; hosting access does not imply licensing rights.

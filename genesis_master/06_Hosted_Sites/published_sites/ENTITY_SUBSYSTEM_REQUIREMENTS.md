# ENTITY Subsystem Requirements — Published Sites
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `06_Hosted_Sites/published_sites`
...
## Subsystem Purpose
Published sites must be explicit disclosure/export states with provenance, rights-impact records and approval evidence.

# ENTITY Subsystem Requirements — Private Sites
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `06_Hosted_Sites/private_sites`
...
## Subsystem Purpose
Private sites must remain default-deny, encrypted where applicable and inaccessible without explicit Entity policy.

# ENTITY Subsystem Requirements — Public Vault
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `08_Data_Vaults/public`
...
## Subsystem Purpose
Public classification permits disclosure only according to current rights/policy; public status does not waive third-party rights.

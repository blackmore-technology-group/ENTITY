# ENTITY Subsystem Requirements — Shared Vault
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `08_Data_Vaults/shared`
...
## Subsystem Purpose
Shared data requires explicit parties, scopes, purposes, retention, revocation semantics and usage evidence where applicable.

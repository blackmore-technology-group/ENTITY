# ENTITY Subsystem Requirements — Vault Exports
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `08_Data_Vaults/exports`
...
## Subsystem Purpose
Exports must be explicit, policy-approved, logged and distinguish source content from external copies. Remote deletion must not be overstated.

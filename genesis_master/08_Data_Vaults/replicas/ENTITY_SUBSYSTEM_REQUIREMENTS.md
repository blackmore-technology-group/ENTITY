# ENTITY Subsystem Requirements — Vault Replicas
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `08_Data_Vaults/replicas`
...
## Subsystem Purpose
Replicas must be encrypted, tracked, integrity-checked and included in deletion/erasure and recovery semantics.

# ENTITY Subsystem Requirements — Network Hardening
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `13_Security/network_hardening`
...
## Subsystem Purpose
Apply secure transport, peer authentication, least exposure, rate limits, replay protection, downgrade protection and abuse controls.

# ENTITY Subsystem Requirements — Key Management
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `13_Security/key_management`
...
## Subsystem Purpose
Support separated authorities, protected root/recovery keys, rotation, revocation, succession, threshold control and auditable key use.

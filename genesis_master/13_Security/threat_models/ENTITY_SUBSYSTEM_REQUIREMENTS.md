# ENTITY Subsystem Requirements — Threat Models
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `13_Security/threat_models`
...
## Subsystem Purpose
Threat models must cover key/device theft, malicious guardians/peers, Sybil, replay, equivocation, exfiltration, prompt injection, ransomware, fake provenance and settlement attacks.

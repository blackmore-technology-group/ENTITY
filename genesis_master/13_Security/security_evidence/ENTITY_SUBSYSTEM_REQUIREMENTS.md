# ENTITY Subsystem Requirements — Security Evidence
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `13_Security/security_evidence`
...
## Subsystem Purpose
Security evidence must be integrity-protected, attributable, versioned and suitable for independent qualification/release review.

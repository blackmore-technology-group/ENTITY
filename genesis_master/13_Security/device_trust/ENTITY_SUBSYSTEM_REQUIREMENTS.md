# ENTITY Subsystem Requirements — Device Trust
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `13_Security/device_trust`
...
## Subsystem Purpose
Device attestation/trust must be revocable, scoped and separate from sovereign identity existence.

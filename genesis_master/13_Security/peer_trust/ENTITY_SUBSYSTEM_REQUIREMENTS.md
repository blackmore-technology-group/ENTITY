# ENTITY Subsystem Requirements — Peer Trust
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `13_Security/peer_trust`
...
## Subsystem Purpose
Peer authorization must evaluate live credentials, trust level, issuer policy, revocation and negotiated protocol/capabilities.

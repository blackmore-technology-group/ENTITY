# ENTITY Subsystem Requirements — Architecture Decision Records
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `00_Governance/decisions`
...
## Subsystem Purpose
Record significant ENTITY architecture decisions, alternatives, rationale, authority, evidence, status and supersession. Decisions must not silently change historical semantics.

# ENTITY Subsystem Requirements — Legal/Jurisdiction Mapping
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `00_Governance/legal_mapping`
...
## Subsystem Purpose
Map rights, consent, licensing, retention, deletion, payment and dispute requirements to modular jurisdiction profiles. Engineering controls must remain distinguishable from legal advice.

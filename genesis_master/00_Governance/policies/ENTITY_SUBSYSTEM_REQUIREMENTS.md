# ENTITY Subsystem Requirements — Governance Policy
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `00_Governance/policies`
...
## Subsystem Purpose
Store versioned governance policies for authority thresholds, approvals, source enrollment, rights, consent, licensing, AI access, export and settlement.

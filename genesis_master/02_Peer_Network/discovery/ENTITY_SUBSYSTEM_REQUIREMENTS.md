# ENTITY Subsystem Requirements — Peer Discovery
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `02_Peer_Network/discovery`
...
## Subsystem Purpose
Discover compatible peers without treating discovery as trust. Trust requires authenticated identity, protocol compatibility and applicable credential/policy evaluation.

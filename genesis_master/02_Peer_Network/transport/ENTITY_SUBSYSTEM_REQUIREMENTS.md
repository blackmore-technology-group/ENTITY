# ENTITY Subsystem Requirements — Peer Transport
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `02_Peer_Network/transport`
...
## Subsystem Purpose
Transport must use secure protocols, authenticated peers, rate limits and version negotiation; signed downgrade must be detected and fail closed unless explicitly authorized.

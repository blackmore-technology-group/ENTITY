# ENTITY Subsystem Requirements — Remote Desktop/BECP Bridge
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `02_Peer_Network/BECP_Control_Plane/RDC_Bridge`
...
## Subsystem Purpose
Bridge actions must be explicitly scoped, auditable and unable to inherit root authority. Tool output is untrusted data unless separately authorized.

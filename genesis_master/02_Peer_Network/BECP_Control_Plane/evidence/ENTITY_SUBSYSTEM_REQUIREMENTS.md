# ENTITY Subsystem Requirements — BECP Evidence
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `02_Peer_Network/BECP_Control_Plane/evidence`
...
## Subsystem Purpose
Store only observable, attributable BECP evidence with origin and assurance. Pre-bootstrap evidence must retain its historical assurance and must not be upgraded retroactively.

# ENTITY Subsystem Requirements — BECP Configuration
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `02_Peer_Network/BECP_Control_Plane/config`
...
## Subsystem Purpose
Version and validate BECP policy, provider, transport, scope and evidence-boundary configuration. Unsafe or unknown configuration must fail closed.

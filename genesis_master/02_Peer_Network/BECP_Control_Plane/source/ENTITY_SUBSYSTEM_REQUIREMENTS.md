# ENTITY Subsystem Requirements — BECP Source
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `02_Peer_Network/BECP_Control_Plane/source`
...
## Subsystem Purpose
Source code in this area must preserve request/response evidence boundaries, scoped authority and provider-internal UNKNOWN semantics.

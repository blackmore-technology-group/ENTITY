# ENTITY Subsystem Requirements — Offline Mesh
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `02_Peer_Network/offline_mesh`
...
## Subsystem Purpose
Support signed offline events, conflict detection, rejoin and reconciliation. Exclusive rights/value conflicts must fail closed until reconciled.

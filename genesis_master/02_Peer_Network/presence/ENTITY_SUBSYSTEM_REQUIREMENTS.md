# ENTITY Subsystem Requirements — Presence
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `02_Peer_Network/presence`
...
## Subsystem Purpose
Presence signals must be minimal, privacy-aware, non-authoritative for identity ownership, and protected against spoofing and correlation.

# ENTITY Subsystem Requirements — Relay Fallback
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `02_Peer_Network/relay_fallback`
...
## Subsystem Purpose
Relays must not gain plaintext or authority unnecessarily; routing through a relay must preserve end-to-end authentication and evidence integrity.

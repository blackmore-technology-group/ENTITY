# ENTITY Subsystem Requirements — NAT Traversal
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `02_Peer_Network/nat_traversal`
...
## Subsystem Purpose
Connectivity assistance must not weaken peer authentication, confidentiality, authorization, replay protection or evidence attribution.

...
IDENTITY=_load("entity_principal_identity",ROOT/"01_Core_Runtime"/"identity"/"canonical_identity.py")
SOVEREIGN=_load("entity_principal_sovereign",ROOT/"04_Entity_Registry"/"relationships"/"canonical_sovereign_authority.py")
OPENSDK=_load("entity_principal_open_sdk",ROOT/"14_Protocols_SDK"/"open_entity_sdk"/"canonical_open_entity_sdk.py")

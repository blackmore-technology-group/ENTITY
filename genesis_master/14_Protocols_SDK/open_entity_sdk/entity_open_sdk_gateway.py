...
STATE=Path(os.environ.get("ENTITY_STATE_DIR",r"<LOCAL_DRIVE>/BTG_ENTITY_PRODUCTION_STATE"))

def _load(name,path):
    spec=importlib.util.spec_from_file_location(name,path)
    mod=importlib.util.module_from_spec(spec); spec.loader.exec_module(mod); return mod

PB=_load("entity_gateway_pb",ROOT/"14_Protocols_SDK"/"principal_binding"/"canonical_principal_binding.py")
SDK11=_load("entity_gateway_sdk11",ROOT/"14_Protocols_SDK"/"open_entity_sdk_v1_1"/"canonical_open_entity_sdk_v1_1.py")
SDK1=_load("entity_gateway_sdk1",ROOT/"14_Protocols_SDK"/"open_entity_sdk"/"canonical_open_entity_sdk.py")

# ENTITY Subsystem Requirements — C2PA Integration
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `14_Protocols_SDK/c2pa`
...
## Subsystem Purpose
Preserve provenance validity, signer trust and factual truth as separate fields/states. C2PA processing requires authorized source access and must not imply ownership.

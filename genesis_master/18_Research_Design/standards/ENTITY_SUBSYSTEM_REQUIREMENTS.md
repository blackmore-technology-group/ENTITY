# ENTITY Subsystem Requirements — Standards
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `18_Research_Design/standards`
...
## Subsystem Purpose
Track DID, VC, ODRL, C2PA, SBOM, cryptographic and transport standards with versions and documented BTG extensions.

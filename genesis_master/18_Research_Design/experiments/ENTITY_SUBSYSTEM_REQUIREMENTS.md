# ENTITY Subsystem Requirements — Experiments
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `18_Research_Design/experiments`
...
## Subsystem Purpose
Experiments must state hypotheses, inputs, environment, results and evidence origin and must not contaminate production authority.

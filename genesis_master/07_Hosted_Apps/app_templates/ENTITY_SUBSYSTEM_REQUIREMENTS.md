# ENTITY Subsystem Requirements — Application Templates
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `07_Hosted_Apps/app_templates`
...
## Subsystem Purpose
Templates must default to least privilege and must not embed secrets, broad capabilities or unverifiable trust assumptions.

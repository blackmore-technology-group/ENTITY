# ENTITY Subsystem Requirements — Installed Applications
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `07_Hosted_Apps/installed_apps`
...
## Subsystem Purpose
Installed apps must have identifiable package/version, granted scopes, revocation state, provenance and audit history.

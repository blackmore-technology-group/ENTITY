# ENTITY Subsystem Requirements — Application Updates
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `07_Hosted_Apps/app_updates`
...
## Subsystem Purpose
Updates must preserve provenance/version history, validate signatures and trigger permission review for materially changed scope.

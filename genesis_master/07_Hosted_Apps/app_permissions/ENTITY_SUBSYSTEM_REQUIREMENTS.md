# ENTITY Subsystem Requirements — Application Permissions
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `07_Hosted_Apps/app_permissions`
...
## Subsystem Purpose
App permissions must be explicit, purpose-scoped, revocable and reevaluated when requested scope changes.

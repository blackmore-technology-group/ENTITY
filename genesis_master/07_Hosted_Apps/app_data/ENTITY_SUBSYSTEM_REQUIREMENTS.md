# ENTITY Subsystem Requirements — Application Data
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `07_Hosted_Apps/app_data`
...
## Subsystem Purpose
App data must follow Entity classification, source enrollment, vault and retention rules. App possession never creates commercialization rights.
